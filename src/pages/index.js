			...
			>
				...
				<header className='sm:w-7/12 my-auto'>
					...
					<p>
						...
						since I was a kid, turning my curiosity into a love for
						web technologies. Today, I happily stare down complex
						systems, handle projects of diverse types and sizes, and
						collaborate on all stages of the development lifecycle,
						from ideation to shipment to ongoing support.
					</p>
				</header>
			</section>
			{/* RESUME */}
			...
			>
				<div className='flex flex-col sm:relative sm:flex-row sm:flex-wrap sm:justify-around'>
					...
					<aside className='sm:w-5/12'>
						...
						<div className='my-4'>
							<h3 className='text-xl'>WordPress Technician</h3>
				...
				<aside>
					...
					<ul className='list-inside list-disc'>
						<li className='my-2'>
							...
							making product-level decisions on JavaScript web and
							mobile applications (React/Next/React Native) and a
							RESTful API written in PHP (Laravel).
						</li>
						<li className='my-2'>
							Design, administer, support and monitor a MySQL
							database and maintain servers provisioned on Amazon
							Web Services (AWS).
						</li>
					</ul>
